...
public class Main {
	...
	ArrayList<ArrayList<String>> test = JDOM1.XMLtoList("/home/erwan/Documents/PAF/Test/test.txt.out");
	//Convertisseur.convertion(test,"/home/erwan/Documents/PAF/frametoimageschema/frames_to_imageschemas.txt");
	JDOM1.ListtoXML(test, "/home/erwan/Documents/PAF/Test/testjava2.xml");
	}
		catch(Exception e){
			e.printStackTrace();
		}
