...
fresultat=open('C:\\Users\\cleme\\Desktop\\image_schemas__modifiees_extraites.txt','w',encoding='UTF8')
fframes= open('C:\\Users\\cleme\\Desktop\\image_schemas_modifiees.txt','r',encoding='UTF8')
